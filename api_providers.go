...
func (r ApiGetProvidersRequest) Execute() (ProvidersResponse, *_nethttp.Response, error) {
 ...
 */
func (a *ProvidersApiService) GetProviders(ctx _context.Context) ApiGetProvidersRequest {
	return ApiGetProvidersRequest{
		ApiService: a,
		ctx: ctx,
	}
 ...
 */
func (a *ProvidersApiService) GetProvidersExecute(r ApiGetProvidersRequest) (ProvidersResponse, *_nethttp.Response, error) {
	var (
