...
func (r ApiGetRegionsRequest) Execute() ([]Region, *_nethttp.Response, error) {
 ...
 */
func (a *RegionsApiService) GetRegions(ctx _context.Context, provider string, service string) ApiGetRegionsRequest {
	return ApiGetRegionsRequest{
		ApiService: a,
		ctx: ctx,
		provider: provider,
 ...
 * @return []Region
 */
func (a *RegionsApiService) GetRegionsExecute(r ApiGetRegionsRequest) ([]Region, *_nethttp.Response, error) {
	var (
