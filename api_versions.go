...
func (r ApiGetVersionsRequest) Execute() ([]LocationVersion, *_nethttp.Response, error) {
 ...
 */
func (a *VersionsApiService) GetVersions(ctx _context.Context, provider string, service string, region string) ApiGetVersionsRequest {
	return ApiGetVersionsRequest{
		ApiService: a,
		ctx: ctx,
		provider: provider,
 ...
 */
func (a *VersionsApiService) GetVersionsExecute(r ApiGetVersionsRequest) ([]LocationVersion, *_nethttp.Response, error) {
	var (
