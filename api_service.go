 ...
 */
func (a *ServiceApiService) GetService(ctx _context.Context, provider string, service string) ApiGetServiceRequest {
	return ApiGetServiceRequest{
		ApiService: a,
		ctx: ctx,
		provider: provider,
 ...
 */
func (a *ServiceApiService) GetServiceExecute(r ApiGetServiceRequest) (ServiceResponse, *_nethttp.Response, error) {
	var (
