...
func (r ApiGetRegionRequest) Execute() (GetRegionResp, *_nethttp.Response, error) {
 ...
 */
func (a *RegionApiService) GetRegion(ctx _context.Context, provider string, service string, region string) ApiGetRegionRequest {
	return ApiGetRegionRequest{
		ApiService: a,
		ctx: ctx,
		provider: provider,
 ...
 */
func (a *RegionApiService) GetRegionExecute(r ApiGetRegionRequest) (GetRegionResp, *_nethttp.Response, error) {
	var (
