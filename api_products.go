...
func (r ApiGetProductsRequest) Execute() (ProductDetailsResponse, *_nethttp.Response, error) {
 ...
 */
func (a *ProductsApiService) GetProducts(ctx _context.Context, provider string, service string, region string) ApiGetProductsRequest {
	return ApiGetProductsRequest{
		ApiService: a,
		ctx: ctx,
		provider: provider,
 ...
 */
func (a *ProductsApiService) GetProductsExecute(r ApiGetProductsRequest) (ProductDetailsResponse, *_nethttp.Response, error) {
	var (
