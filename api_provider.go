...
func (r ApiGetProviderRequest) Execute() (ProviderResponse, *_nethttp.Response, error) {
 ...
 */
func (a *ProviderApiService) GetProvider(ctx _context.Context, provider string) ApiGetProviderRequest {
	return ApiGetProviderRequest{
		ApiService: a,
		ctx: ctx,
		provider: provider,
 ...
 */
func (a *ProviderApiService) GetProviderExecute(r ApiGetProviderRequest) (ProviderResponse, *_nethttp.Response, error) {
	var (
